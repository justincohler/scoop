        ...
        <b-row align-h="center" align-v="center" style="min-height: 500px">
            <b-col cols="4">
                ...
                <b-card
                        ...
                        <div class="my-4 lead_text text-center" id="lead">
                            Login	
                        </div>
                        ...
                        <b-form @submit="loginUser">
                            ...
                            <b-form-text v-show="loginFailed" id="passwordHelpBlock" class="mb-4 support_text" style="color: red !important">
                                Your password and/or username is incorrect. Please try again.
                            </b-form-text>
